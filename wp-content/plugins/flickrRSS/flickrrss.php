...
function flickr_stylesheet(){
	?>
	<style type="text/css">
		#flickr    { padding: 0px; margin-left: 15px; }
  	#flickr li { list-style-type: none; margin: 0px; padding: 0px; display: inline; }
  	#flickr li a { display:block; float: left; margin-right: 15px; }
  	img.photo { margin: 0 20px 5px 0; }
	</style>
	<?php
}

add_action('wp_head','flickr_stylesheet');
