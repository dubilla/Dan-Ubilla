...
# Plugin Name: Last.Fm Sidekick
# Version: 0.4
# Plugin URI: http://www.danubilla.com
# Description: The Last.Fm Sidekick plugin displays content from your last.fm profile onto your sidebar.  Based on <a href="http://jeroensmeets.net/lastfmrecords/">Twitter for Wordpress</a> by <a href="http://jeroensmeets.net/">Jeroen</a>.
# Author: Dan Ubilla
...
class LastFmRecords {
  ...
  public function display_lastfm($period = false, $count = false) {
...
?>
  <!-- added by plugin Last.Fm Sidekick -->
  <style type="text/css">
    #lastfmrecords    { padding: 0px; margin-left: 15px; }
